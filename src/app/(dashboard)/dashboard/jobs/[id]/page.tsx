        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-navy-450 text-xs text-navy-400 mt-1">
              Jobb-ID: <code className="text-navy-300 font-mono">{id}</code>
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl border border-navy-850 bg-navy-900/40 backdrop-blur-sm space-y-5">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-navy-450 text-navy-450 text-navy-450 text-navy-400">Sökord</div>
          ...
          {job.status === 'queued' || job.status === 'running' ? (
            <div className="p-16 text-center border border-navy-850 bg-navy-900/20 rounded-2xl">
              ...
              <p className="text-xs text-navy-500">
                Leadlistan genereras i bakgrunden. Förhandsgranskningen uppdateras när jobbet är klart.
              </p>
            </div>
          ) : job.status === 'failed' ? (
            <div className="p-16 text-center border border-navy-850 bg-navy-900/20 rounded-2xl">
            ...
            <div className="p-16 text-center border border-navy-850 bg-navy-900/20 rounded-2xl">
              ...
              <p className="text-xs text-navy-550 text-navy-400">
